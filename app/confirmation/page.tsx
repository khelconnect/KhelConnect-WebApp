...
import { Calendar, Clock, MapPin, Download, Share2, CheckCircle, Home, ArrowLeft } from "lucide-react"
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-lg">{sportNames[bookingDetails.sport as keyof typeof sportNames]}</p>
                  </div>
                </div>
              </div>
